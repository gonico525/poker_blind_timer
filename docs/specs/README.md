...
4. **03-design-system.md** - UIの統一ルールの把握
5. **担当機能のドキュメント** - 実装詳細の確認

### 機能実装開始時

担当する機能のドキュメントを中心に、以下を参照：

- **タイマー実装**: timer.md → 02-data-models.md
- **ブラインド管理実装**: blinds.md → 02-data-models.md → timer.md
- **プリセット実装**: presets.md → storage.md → 02-data-models.md
- **音声通知実装**: audio.md → timer.md
- **キーボード実装**: keyboard.md → timer.md
- **データ永続化実装**: storage.md → 02-data-models.md
